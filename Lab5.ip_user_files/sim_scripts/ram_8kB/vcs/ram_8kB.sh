...
# executing this script. Please type 'ram_8kB.sh -help' for more information.
#
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../Lab4.srcs/sources_1/ip/ram_8kB/ram_8kB_sim_netlist.vhdl" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_8kB xil_defaultlib.glbl -o ram_8kB_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_8kB_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ram_8kB_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc ram_8kB_simv.daidir)
